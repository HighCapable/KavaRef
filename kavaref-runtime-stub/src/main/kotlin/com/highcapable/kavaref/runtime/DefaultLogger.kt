...
class DefaultLogger : KavaRefRuntime.Logger {
    ...
    override fun info(msg: Any?, throwable: Throwable?) = kotlin.error("Stub!")
    override fun warn(msg: Any?, throwable: Throwable?) = kotlin.error("Stub!")
    override fun error(msg: Any?, throwable: Throwable?) = kotlin.error("Stub!")
}